...
void *worker_thread() {
    ...
    while (1) {
        ...
        file_info_t file = buffer.buffer[buffer.out];
...
int main(int argc, char *argv[]) {
    ...
    pthread_barrier_init(&barrier, NULL, num_workers);  // Initialize the barrier
    ...
    char *manager_args[] = { src_dir, dest_dir };
    ...
    pthread_t worker_thread_id[num_workers];
